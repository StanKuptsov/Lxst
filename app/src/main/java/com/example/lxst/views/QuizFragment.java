...
import com.example.lxst.viewmodel.QuizListViewModel;
...
public class QuizFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.option3Btn)
        {
            verifyAnswer(option3Btn);
        }
        else
        if (v.getId() == R.id.nextQueBtn)
        {
            if (currentQueNo == totalQuestions)
            {
                submitResults();
    ...
    private void submitResults() {
        ...
        resultMap.put("correct" , String.valueOf(correctAnswer));
        resultMap.put("wrong" , String.valueOf(wrongAnswer));
        resultMap.put("notAnswered" , String.valueOf(notAnswerd));
